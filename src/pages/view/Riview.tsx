...
const ReviewsSection: React.FC = () => {
  const reviews = [
    ...
    },
    {
      ...
      review:
        "Curabitur fringilla enim non magna posuere, non venenatis purus blandit...",
    },
    {
      name: "Jonny",
      title: "Senior Designer",
      company: "Spotify",
      image: "Avatar-jonny.png",
      review:
        "Aenean id purus id libero dapibus tristique. In a lorem vel quam sodales...",
    },
  ];
